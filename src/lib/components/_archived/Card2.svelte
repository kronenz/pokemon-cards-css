<script>
	...
	export let img = '';
	export let back =
		'https://i.ibb.co/bd8nxRt/Monosnap-ee6faf9d-4225-409c-9aa5-a38c8fe39eb9-webp-2024-07-25-15-08-38.png';
	export let foil = '';
	export let mask = '';
	...
	<div class="card__translater">
		...
		>
			...
			<div class="card__front" style={staticStyles + foilStyles}>
				...
				<div
					class="card__name"
					style="position: absolute; top: 20px; right: 20px; width: 100%; opacity: 0.6; z-index: 10;"
				>
					<h2
						style="font-size: 2em; color: white; text-align: right; margin: 0; padding-right: 20px;"
					>
						{subtypes}
					</h2>
				</div>
